...
public class OutputThread extends Thread {
    ...
    /**
     * Constructs an OutputThread for the underlying IRCClient.  All messages
     ...
     * 
     * @param bot The underlying IRCClient instance.
     * @param outQueue The Queue from which we will obtain our messages.
     */
    public OutputThread(IRCClient bot, Queue outQueue) {
        _bot = bot;
        _outQueue = outQueue;
        this.setName("QC Output");
    }
    
    
    /**
     * A static method to write a line to a BufferedOutputStream and then pass
     * the line to the log method of the supplied IRCClient instance.
     * 
     * @param bot The underlying IRCClient instance.
     ...
     *                 byte array.
     */
    public static void sendRawLine(IRCClient bot, BufferedWriter bwriter, String line) {
    ...
    public IRCClient _bot = null;
    public Queue _outQueue = null;
