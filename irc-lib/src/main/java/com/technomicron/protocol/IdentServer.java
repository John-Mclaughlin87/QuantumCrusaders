...
public class IdentServer extends Thread {
     ...
     * respond to a client with the provided register.  Rather than calling
     * this constructor explicitly from your code, it is recommended that
     * you use the startIdentServer method in the IRCClient class.
     *  <p>
     ...
     * to an ident request.
     *
     * @param bot The IRCClient instance that will be used to log to.
     * @param login The register that the ident server will respond with.
     */
    IdentServer(IRCClient bot, String login) {
        _bot = bot;
        _login = login;
