...
public class User {
     ...
     *
     * @param prefix The activity_main_status of the user, for example, "@".
     ...
     * activity_main_status in that channel.
     *
     ...
     * in a channel, then this will reflect the user's operator activity_main_status in
     * that channel.
     * 
     ...
     * in a channel, then this will reflect the user's voice activity_main_status in
     * that channel.
     * 
