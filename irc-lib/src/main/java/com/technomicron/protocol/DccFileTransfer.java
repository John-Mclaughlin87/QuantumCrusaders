...
public class DccFileTransfer {
     ...
     */
    DccFileTransfer(IRCClient bot, DccManager manager, String nick, String login, String hostname, String type, String filename, long address, int port, long size) {
        _bot = bot;
        _manager = manager;
        _nick = nick;
        _login = login;
     ...
     */
    DccFileTransfer(IRCClient bot, DccManager manager, File file, String nick, int timeout) {
        _bot = bot;
        _manager = manager;
        _nick = nick;
        _file = file;
    ...
    /**
     * Returns the register of the file sender.
     * 
     * @return the register of the file sender. null if we are sending.
     * 
     */
