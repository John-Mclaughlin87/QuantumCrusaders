...
public class DccChat {
     ...
     */
    DccChat(IRCClient bot, String nick, String login, String hostname, long address, int port) {
        _bot = bot;
        _address = address;
        _port = port;
        _nick = nick;
     ...
     */
    DccChat(IRCClient bot, String nick, Socket socket) throws IOException {
        _bot = bot;
        _nick = nick;
        _socket = socket;
    ...
    /**
     * Returns the register of the DCC Chat initiator.
     * 
     * @return the register of the DCC Chat initiator. null if we sent it.
     * 
     */
